...
export default function AdminHospedagemPage() {
  ...
  const [modal, setModal] = useState<{ open: boolean; editing: Hospedagem | null }>(
  ...
  const toggleTag = (tag: string) => {
    setForm((prev) => {
      ...
      return { ...prev, tags: current.includes(tag) ? current.filter((t) => t !== tag) : [...current, tag] };
    });
  };
        ...
        <AdminTable
          ...
          columns={[
              ...
              render: (_val, row) => {
                ...
                return (
                  <div className="flex flex-wrap gap-1">
                    ...
                    {t.length > 3 && <span className="text-xs text-muted-foreground">+{t.length - 3}</span>}
                  </div>
                );
              },
            },
            ...
            },
            {
              ...
              render: (_val, row) => (
                <ValidityBadge validade={(row as Hospedagem & { validade?: string }).validade} />
              ),
            },
          ]}
          extraActions={(row) => (
          ...
          <div className="space-y-4">
            {viewing.logoUrl && (
              <div className="flex items-center gap-3">
                ...
                <img src={viewing.logoUrl} alt={viewing.nome}
            ...
            <div className="rounded-xl border border-border bg-muted/20 p-4 space-y-3">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <ValidityBadge validade={(viewing as Hospedagem & { validade?: string }).validade} />
              </div>
            </div>
          </div>
        )}
