...
export default function GastronomiaAdminPage() {
  ...
  function openEdit(item: Gastronomia) {
    ...
    setForm({
      ...
      endereco: item.endereco ?? "", especialidade: item.especialidade ?? "",
  ...
  return (
    <div className="space-y-6">
      ...
      <AdminModal open={modalOpen} onClose={() => setModalOpen(false)}
        ...
        <AdminFormField label="Especialidade" value={form.especialidade} onChange={e => setForm(f => ({ ...f, especialidade: e.target.value }))} />
