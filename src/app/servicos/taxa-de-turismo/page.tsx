...
import { ArrowLeft, FileText, Bus, ExternalLink, Info, Trophy, Building2 } from "lucide-react";
      ...
      <div className="container mx-auto max-w-4xl px-4 py-16 space-y-12">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            <strong className="text-foreground">preservação do patrimônio natural, cultural e urbano</strong>, além de
            garantir uma experiência segura e ordenada para visitantes e moradores.
          </p>
          <div className="flex items-start gap-3 rounded-xl border border-primary/20 bg-primary/5 px-4 py-3">
            <Info size={18} className="mt-0.5 shrink-0 text-primary" />
            <p className="text-sm text-foreground">
              Conforme o{" "}
              <strong>Decreto Municipal nº 2.572/2023</strong>, todo veículo de turismo (ônibus,
              micro-ônibus e vans) deve{" "}
              <strong>solicitar previamente autorização para entrada no município</strong>. O
              procedimento é realizado de forma{" "}
              <strong>100% online</strong>, rápida e segura.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-xl border border-border bg-card p-5 space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <strong className="text-foreground">emitir previamente a Autorização de Acesso</strong>, a qual deverá ser fixada{" "}
        ...
        <section className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-border bg-muted/30 py-10 px-4 text-center">
          ...
          <p className="text-sm text-muted-foreground max-w-md">
            Para emitir autorizações, acessar o sistema oficial ou obter mais informações, acesse
            o portal da Prefeitura de Saquarema.
          </p>
          <a
            href="https://www.saquarema.rj.gov.br/pagamento-da-taxa-de-turismo/"
            target="_blank"
