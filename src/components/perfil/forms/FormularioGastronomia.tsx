        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4">
            <button
              type="button"
              onClick={() => router.back()}
              className="px-4 py-2 text-sm border rounded-md transition hover:bg-muted"
            >
              Cancelar
            </button>
            <button
              type="submit"
              disabled={saving}
              className="px-4 py-2 text-sm text-white bg-primary rounded-md transition hover:bg-primary/90 disabled:opacity-50"
            >
